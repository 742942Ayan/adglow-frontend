...
const mockTasks = [
  ...
  },
  {
    ...
    description: 'Follow Instagram Profile XYZ',
    reward: 8,
    time: 15,
  },
];
...
const Tasks = () => {
  ...
  const handleMarkAsDone = (task) => {
    ...
    alert(`✅ Task marked as done!\nReward ₹${task.reward * 0.5} added to your wallet.\nRemaining ₹${task.reward * 0.5} will go to your upline network.`);
  };
        ...
        <div className="space-y-4">
          {tasks.map((task) => (
            <div key={task.id} className="p-4 bg-white rounded-lg shadow">
              ...
              <p className="text-sm text-gray-500">Watch Time: {task.time}s</p>
